...
test("POST lOGIN-> 'URL_BASE/login' should return status code 200, res.body to be defined and res.body.user.email === user.email, and res.body.token to be defined", async () => {
    const userLogin = {
        email: "rene@gmail.com",
        password: "rene1234",
    }
...
test("POST lOGIN Error-> 'URL_BASE/login' should return status code 401", async () => {
    const userLogin = {
        email: "rene@gmail.com",
